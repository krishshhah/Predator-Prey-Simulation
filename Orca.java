 ...
 * Orcas age, move, eat rabbits, and die.
 *
...
public class Orca extends Animal
{
    ...
    public Orca(boolean randomAge, Location location)
    {
        ...
        foodLevel = rand.nextInt(TURTLE_FOOD_VALUE) + 10;
    ...
    private void giveBirth(Field nextFieldState, List<Location> freeLocations, List<Location> adjacentLocations)
    {
        ...
        int maleCount = 0;
        if(!this.male && canBreed()) { // if female - only females can 'give birth'
            // find the number of animals in the nextFieldState which are male turtles
